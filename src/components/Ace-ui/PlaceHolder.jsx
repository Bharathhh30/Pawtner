  ...
  return (
    (<form
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full  text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4  pr-[400px]",
